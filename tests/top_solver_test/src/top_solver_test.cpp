...
TEST(top_n, all_equal_top_1)
{
  ...
  ASSERT_EQ(1, top_1.size());
  ASSERT_EQ(s, top_1.front().first);
  ASSERT_EQ(n, top_1.front().second);
}

TEST(top_n, all_equal_top_2)
{
  const std::size_t n = 10;
  const std::string s = "x";
  ...
  ASSERT_EQ(1, top_2.size());
  ASSERT_EQ(s, top_2.front().first);
  ASSERT_EQ(n, top_2.front().second);
}

TEST(top_n, all_different_once)
{
...
TEST(top_n, all_different_desc_order)
{
  const std::string s1 = "a";
  const std::string s2 = "b";
  const std::string s3 = "c";
...
TEST(top_n, all_different_asc_order)
{
  const std::string s1 = "a";
  const std::string s2 = "b";
  const std::string s3 = "c";
